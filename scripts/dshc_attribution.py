...
BOTS = [
    # F 已判失败; 端口 18081 已移交 I。指向不存在端口防串号。
    ("F", "负费率+急跌 M3CarryDip(已判失败)", "m3dsc-freqtrade-f", "DSHC_F_API_PORT", 18997),
    ("B", "反弹 M3DipRevert", "m3dsc-freqtrade-dip", "DSHC_DIP_API_PORT", 18084),
    ("C", "Carry M3CarryLong(已停用)", "m3dsc-freqtrade-carry", "DSHC_CARRY_API_PORT", 18996),
    ...
    ("H", "正费率+1h急跌 M3DipTrend", "m3dsc-freqtrade-htrend", "DSHC_HTREND_API_PORT", 18086),
    ("I", "正费率+15m急跌 M3DipTrend15", "m3dsc-freqtrade-htrend15", "DSHC_HTREND15_API_PORT", 18081),
]
